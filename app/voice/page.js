...
export const metadata = {
  ...
  description:
    'Stop sending AI sludge to your market. Download the DISC Voice — the behavioral infrastructure Rev Vaughn uses to scale content while maintaining human trust.',
}
...
export default function VoicePage() {
  return (
    <>
      {/* MailerLite Universal — TODO: replace ACCOUNT_ID with Rev's MailerLite account ID */}
